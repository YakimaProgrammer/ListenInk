...
function MainApp() {
    const { categories, documents, curDocument, setCurDocument, addNewDocument, pdfByDocId } = useCategories();
            ...
            <main className="main-content">
                <div className="top-view">
                    <div className="hstack">
                        ...
                        <button className={`toggle ${!isSidebarVisible ? "sidebar-hidden" : ""}`} onClick={handleAddDocument}>
